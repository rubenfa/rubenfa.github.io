...
Como nota curiosa, un día le pedía a la Cline que implementara un servicio de scrapping y **se inventó una librería. Me añadió la dependencia e intentó incluso instalarla. Pero no había rastro de esa librería en internet**. Y no debo ser el único al que le ha sucedido, porque incluso [hay un vector de ataque](https://www.theregister.com/2025/04/12/ai_code_suggestions_sabotage_supply_chain) que se aprovecha de estos errores.
